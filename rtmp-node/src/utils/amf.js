...
/**
 * @typedef {'connect' | 'releaseStream' | 'FCPublish' | 'createStream' | 'publish' | 'play' | 'pause' | 'FCUnpublish' | 'deleteStream' | 'closeStream' | 'receiveAudio' | 'receiveVideo'} CommandName
 * @typedef {Object} CommandObject
 * @prop {string} app
 * @prop {any} objectEncoding
 *
 * @typedef {Object} ActionCommand
 * @prop {number} transId
 * @prop {string} streamName
 * @prop {CommandName} cmd
 * @prop {CommandObject} cmdObj
 */
